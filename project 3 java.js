...
function checkAnswer() {
  ...
  // if the answer the user selected is right, increment correct counter
  if (choice == questions[pos].answer) {
    correct++;
  }

  // we move on to the next question by incrementing the position counter
  pos++;

  // we then render the next question and since the pos has been incremented, it will show the next question
  renderQuestion();
}

// listeners for when window is finished loading
